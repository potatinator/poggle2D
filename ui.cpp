...
ColoredButton::ColoredButton(glm::vec2 pos, glm::vec3 col, glm::vec2 scale, int layer, float angle)
    : Button(pos, scale, layer, angle, Shader("./shaders/main.vert", "./shaders/color.frag")), idleCol(col), hoverCol(col), pressCol(col){}
ColoredButton::ColoredButton(glm::vec2 pos, glm::vec3 idleCol, glm::vec3 pressCol, glm::vec2 scale, int layer, float angle)
    : Button(pos, scale, layer, angle, Shader("./shaders/main.vert", "./shaders/color.frag")), idleCol(idleCol), hoverCol(idleCol), pressCol(pressCol){}
ColoredButton::ColoredButton(glm::vec2 pos, glm::vec3 idleCol, glm::vec3 hoverCol, glm::vec3 pressCol, glm::vec2 scale, int layer, float angle)
    : Button(pos, scale, layer, angle, Shader("./shaders/main.vert", "./shaders/color.frag")), idleCol(idleCol), hoverCol(hoverCol), pressCol(pressCol){}
...
void ColoredButton::draw(){
    ...
    shader.use();
    shader.setVec3("color", glm::vec3(1.0, 10, 1.0));
    Button::draw();
}